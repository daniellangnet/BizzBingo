namespace BizzBingo.Web.Infrastructure.DotNetOAuth
{
    ...
    public class RavenDbTokenManager : IConsumerTokenManager
    {
        private Dictionary<string, string> tokensAndSecrets = new Dictionary<string, string>();

        /// <summary>
        /// Initializes a new instance of the <see cref="RavenDbTokenManager"/> class.
		/// </summary>
		/// <param name="consumerKey">The consumer key.</param>
		/// <param name="consumerSecret">The consumer secret.</param>
        public RavenDbTokenManager(string consumerKey, string consumerSecret)
        {
